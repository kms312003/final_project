...
<body>
    ...
    <center>
	<form action="<%= request.getContextPath() %>/admin/power/update" enctype="multipart/form-data" method="post" name="updateform" onsubmit="return checkPower()">
	...
	<input type="hidden" name="oldfilesize" value="${ power.filesize }">
		...
		<h2>Power 수정</h2>	
			<table class="table table-bordered" style="width:80%;">
				...
				<tr>
					<td>제조회사</td>
					<td><input type="text" name="productCompany" size="50" maxlength="20" value="${power.productCompany}"></td>
				</tr>
				<tr>
					<td>제품 분류</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<%= request.getContextPath() %>/admin/power/delete?id=${ no }'">Delete</button>
      </div>
    </div>
  </div>
</div>
