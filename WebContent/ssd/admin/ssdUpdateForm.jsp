...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <center>
	<form action="<%= request.getContextPath() %>/admin/ssd/update" enctype="multipart/form-data" method="post" name="updateform" onsubmit="return checkSSD()">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<%= request.getContextPath() %>/admin/ssd/delete?id=${ no }'">Delete</button>
      </div>
    </div>
  </div>
</div>
