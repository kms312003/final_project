...
<body>
<form method="post" name="writeform" enctype="multipart/form-data" action="<%=request.getContextPath() %>/board_information/write"
...
<tr>
   ...
   OnClick = "window.location='<%=request.getContextPath() %>/board_information/list'">
   </td>
   </tr>
</table>
</div>
