...
<body>
<form method="post" name="writeform" enctype="multipart/form-data" action="<%=request.getContextPath() %>/qa/writePro"
...
<tr>
   ...
   OnClick = "window.location='<%=request.getContextPath() %>/qa/list'">
   </td>
   </tr>
</table>
</div>
