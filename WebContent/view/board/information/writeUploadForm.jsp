...
<body>
<form method="post" name="writeform" enctype="multipart/form-data" action="<%=request.getContextPath() %>/information/writePro"
...
<tr>
   ...
   OnClick = "window.location='<%=request.getContextPath() %>/information/list'">
   </td>
   </tr>
</table>
</div>
