...
<body>            
    ...
    <center>
	<form action="<%= request.getContextPath() %>/admincpu/updatePro" enctype="multipart/form-data" method="post" name="updateform" onsubmit="return checkCpu()">
		...
		<h2>Cpu 수정</h2>	
			<table class="table table-bordered" style="width:80%;">
				...
				<tr>
					...
					<input type="button" class="btn btn-default" value="List" onclick="window.location='<%= request.getContextPath() %>/admincpu/list'">
					</td>
				</tr>
				</center>
			</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<%= request.getContextPath() %>/admincpu/delete?id=${ no }'">Delete</button>
      </div>
    </div>
  </div>
</div>
