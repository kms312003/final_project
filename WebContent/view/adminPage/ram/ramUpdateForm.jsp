...
<body>            
    ...
    <center>
	<form action="<%= request.getContextPath() %>/adminram/updatePro" enctype="multipart/form-data" method="post" name="updateform" onsubmit="return checkRam()">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<%= request.getContextPath() %>/adminram/delete?id=${ no }'">Delete</button>
      </div>
    </div>
  </div>
</div>
