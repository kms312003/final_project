	...
	<input type="hidden" name="oldfilesize" value="${ filesize }">
		...
		<h2>RAM 상세보기</h2>	
			<table class="table table-bordered" style="width:80%;">
				...
				<tr>
					<td>동작클럭</td>
					<td align="center" width="330">${ clock} MHz</td>
				</tr>
				<tr>
					<td>동작전압</td>
					<td align="center" width="330">${ voltage} V</td>
				</tr>
				...
				<tr>
					<td colspan="2">
					<input type="button" class="btn btn-default" value="Update" onclick="window.location='<%= request.getContextPath() %>/adminram/update?id=${no}'"> 
