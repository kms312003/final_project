	...
	<div class="container" style="margin-top: 10px; margin-bottom: 10px;">
		<center>
			...
			<form id="Update" name="updateForm" method="post"
				action="<%=request.getContextPath()%>/user/updatePro"
				...
				<table class="table table-bordered">
					...
					<p>
						<input type="text" id="sample4_postcode" name="postcode"
							...
							style="margin: 20px; width: 200px;" class="btn btn-primary"
							onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="sample4_roadAddress" name="roadAddress"
							placeholder="도로명주소"> <input type="text"
							id="sample4_jibunAddress" name="jibunAddress" placeholder="지번주소">
					...
					<p>
						<input class="btn btn-primary" type="submit" value="변경"> <input
							...
							Onclick="window.location='<%=request.getContextPath()%>/user/userInfo'">
					</p>
