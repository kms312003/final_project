...
<script>
	...
	<h2 style="margin:50px; width:100%; text-align:center;">메모리 목록</h2>
	<!-- 리스트 목록 검색 -->
	<div class="container" style="margin-top:30px; margin-bottom:30px;">
		<form name="search_list" method="post" action="<%= request.getContextPath() %>/ram/listPost">
				...
				<tbody>
					<tr>
						...
						<td width="80%">
							...
							<label class="checkbox-inline"><input type="checkbox" name="productCompany" value="GSKILL" <c:if test="${fn:contains(line, 'GSKILL')}">checked</c:if>>GSKILL</label>
							<label class="checkbox-inline"><input type="checkbox" name="productCompany" value="GEIL" <c:if test="${fn:contains(line, 'GEIL')}">checked</c:if>>GEIL</label>
							<script>
