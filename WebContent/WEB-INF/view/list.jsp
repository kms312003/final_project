...
%>
   ...
   <a href="<%=request.getContextPath() %>/board/write">글쓰기</a></span>
   ...
   <table class="w3-table-all" width="700">
    ...
    <c:if test="${article.re_level > 0 }"> 
         ...
         <a href="<%=request.getContextPath() %>/board/content?num=${article.num }&no=${number}">${article.inform}${article.subject }</a></td>         
