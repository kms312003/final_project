...
<body>
<form method="post" name="writeform" enctype="multipart/form-data" action="<%=request.getContextPath() %>/board2/write"
...
<tr>
   ...
   OnClick = "window.location='<%=request.getContextPath() %>/board2/list'">
   </td>
   </tr>
</table>
</div>
